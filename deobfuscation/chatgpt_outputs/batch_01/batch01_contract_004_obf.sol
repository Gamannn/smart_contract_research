...
contract Timelock {
    ...
    constructor(address admin, uint delay) public {
        require(delay >= config.minDelay, "Timelock::constructor: Delay must exceed minimum delay.");
        require(delay <= config.maxDelay, "Timelock::constructor: Delay must not exceed maximum delay.");
        config.admin = admin;
        config.delay = delay;
    }
    ...
    function setDelay(uint delay) public {
        ...
        require(delay >= config.minDelay, "Timelock::setDelay: Delay must exceed minimum delay.");
        require(delay <= config.maxDelay, "Timelock::setDelay: Delay must not exceed maximum delay.");
        config.delay = delay;
    ...
    function setPendingAdmin(address pendingAdmin) public {
        ...
        config.pendingAdmin = pendingAdmin;
