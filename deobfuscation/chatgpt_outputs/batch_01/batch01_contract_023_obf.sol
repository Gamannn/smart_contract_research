...
contract StatusBuyer {
    ...
    function withdraw() {
        ...
        uint256 contractValue = (contractEthBalance * 10000) + contractSNTBalance;
        uint256 ethAmount = (userDeposit * contractEthBalance * 10000) / contractValue;
        uint256 sntAmount = 10000 * ((userDeposit * contractSNTBalance) / contractValue);
        uint256 fee = 0;
    ...
    address payable[] public _address_constant = [
        0x4e6A1c57CdBfd97e8efe831f8f4418b1F2A09e6e,
        0x744d70FDBE2Ba4CF95131626614a1763DF805B9E,
        0x55d34b686aa8C04921397c5807DB9ECEdba00a4c,
        0xc636e73Ff29fAEbCABA9E0C3f6833EaD179FFd5c
    ];
    
    uint256[] public _integer_constant = [100, 10000, 0, 30000000000000000000];
