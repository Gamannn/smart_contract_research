...
contract CirclesTokenOffering is Ownable {
    ...
    OfferingDetails public offeringDetails;
    ...
    function buyTokens(address beneficiary) payable {
        ...
        uint256 tokens = weiAmount.mul(offeringDetails.rate);

        offeringDetails.weiRaised = offeringDetails.weiRaised.add(weiAmount);
    ...
    function claimTokens() {
        require(offeringDetails.isFinalized);
        require(goalReached());
    ...
    function validPurchase() internal constant returns (bool) {
        bool withinCap = offeringDetails.weiRaised.add(msg.value) <= offeringDetails.cap;
        bool withinPeriod = now >= offeringDetails.startTime && now <= offeringDetails.endTime;
        bool nonZeroPurchase = msg.value != 0;
        return withinPeriod && nonZeroPurchase && withinCap;
    }

    function hasEnded() public constant returns (bool) {
        bool capReached = offeringDetails.weiRaised >= offeringDetails.cap;
        bool passedEndTime = now > offeringDetails.endTime;
    ...
    function goalReached() public constant returns (bool) {
        return offeringDetails.weiRaised >= offeringDetails.goal;
    }
    ...
    function finalize() onlyOwner {
        ...
        Finalized();
        offeringDetails.isFinalized = true;
    }
