...
contract ParsecTokenERC20 {
    ...
    function ParsecTokenERC20() public {
        ...
        symbol = "PRSC";
        decimals = 6;
        totalSupply = 30856775800 * 10 ** uint256(decimals);
...
contract ParsecCrowdsale is Owned {
    ...
    enum KycState { Undefined, Pending, Accepted, Declined }

    ParsecTokenERC20 private parsecToken;
    address public multisigAddress;
    address public auditorAddress;
    uint256 public BONUS_TIER_9_LIMIT = 9210 ether;
    uint256 public BONUS_TIER_8_LIMIT = 7735 ether;
    uint256 public BONUS_TIER_7_LIMIT = 6609 ether;
    uint256 public BONUS_TIER_6_LIMIT = 5532 ether;
    uint256 public BONUS_TIER_5_LIMIT = 4478 ether;
    uint256 public BONUS_TIER_4_LIMIT = 3446 ether;
    uint256 public BONUS_TIER_3_LIMIT = 2434 ether;
    uint256 public BONUS_TIER_2_LIMIT = 1443 ether;
    uint256 public BONUS_TIER_1_LIMIT = 715 ether;
    uint256 public PARSECS_TOTAL_AMOUNT = 16103862002000000;
    uint256 public PARSECS_PER_ETHER_BASE = 1300000000000;
    uint256 public MINIMUM_PARTICIPATION_AMOUNT = 0.1 ether;
