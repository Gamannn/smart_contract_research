...
contract JincorTokenICO is Haltable, PriceReceiver {
    ...
    struct ICOConfig {
        uint256 VOLUME_5_REF_3;
        uint256 VOLUME_7_REF_4;
        uint256 VOLUME_10_REF_5;
        uint256 VOLUME_12d5_REF_5d5;
        uint256 VOLUME_15_REF_6;
        uint256 VOLUME_20_REF_7;
    ...
    ICOConfig public config = ICOConfig(
        100 ether,
        250 ether,
        500 ether,
        1000 ether,
