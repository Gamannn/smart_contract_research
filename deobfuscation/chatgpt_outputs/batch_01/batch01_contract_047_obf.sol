...
contract Eightherbank {
    ...
    function purchaseTokens(address _customerAddress, uint256 _incomingEthereum, address _referredBy) antiEarlyWhale(_incomingEthereum) internal returns (uint256) {
    ...
    uint256 public ACTIVATION_TIME = 1574013600;
    bool public onlyAmbassadors = true;
    uint256 public ambassadorMaxPurchase_ = 1 ether;
    address public devFeeAddress;
    address public promoFeeAddress;
    ...
    uint8 public refferalFee_ = 33;
    uint8 public transferFee_ = 5;
