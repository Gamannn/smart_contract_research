...
contract Neutrino81 {
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _ref1, address _ref2, address _ref3) internal returns (uint256) {
        ...
        if (_ref1 != 0x0000000000000000000000000000000000000000 && tokenBalanceLedger_[_ref1] * tokenPrice >= stakingRequirement) {
        ...
        if (_ref2 != 0x0000000000000000000000000000000000000000 && tokenBalanceLedger_[_ref2] * tokenPrice >= stakingRequirement) {
        ...
        if (_ref3 != 0x0000000000000000000000000000000000000000 && tokenBalanceLedger_[_ref3] * tokenPrice >= stakingRequirement) {
    ...
    function passRepay(address customerAddress) public payable onlyBoss2 {
        ...
        require(_value > 0);
        repayBalance_[customerAddress] += _value;
        emit OnRepayPassed(customerAddress, _value, now);
    }
