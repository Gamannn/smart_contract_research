...
contract KaasyToken is ERC20Interface, Pausable, SafeMath {
    ...
    uint8 public teamWOVestingPercentage;
    ...
    function () public payable whenNotPaused {
        if (now > endDate && !isMintingFinished) {
            ...
            require(kycAddressState[msg.sender]);
    ...
    function transfer(address to, uint tokens) public whenNotPaused returns (bool success) {
        ...
        require(now >= tradingDate || kycAddressState[to] || msg.sender == addrMarketing);
    ...
    function transferFrom(address from, address to, uint tokens) public whenNotPaused returns (bool success) {
        ...
        require(now >= tradingDate || kycAddressState[to]);
