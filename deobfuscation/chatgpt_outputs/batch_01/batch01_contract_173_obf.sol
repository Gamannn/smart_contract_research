...
contract Crowdfunding {
    ...
    constructor(address beneficiary, uint fundingGoalInEther, uint durationInMinutes) public {
    ...
    function () payable external {
        require(!campaign.fundingClosed);
    ...
    function checkGoalReached() public afterDeadline {
        ...
        campaign.fundingClosed = true;
    }

    function withdrawFunds() public afterDeadline {
