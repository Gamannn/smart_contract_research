...
contract Halo3DShrimpFarmer is AcceptsHalo3D {
    ...
    function Halo3DShrimpFarmer(address _tokenContract) AcceptsHalo3D(_tokenContract) public {
        ceoAddress = msg.sender;
    }

    function() payable public {}

    function tokenFallback(address _from, uint256 _value, bytes _data) external onlyTokenContract returns (bool) {
        require(initialized);
