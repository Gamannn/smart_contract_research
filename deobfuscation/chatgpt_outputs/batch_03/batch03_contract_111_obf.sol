...
contract RiceFarmer {
    ...
    function hatchSeeds(address ref) public {
        ...
        uint256 newRice = SafeMath.div(seedsUsed, SEEDS_TO_HATCH_1RICE);
    ...
    function calculateTrade(uint256 rt, uint256 rs, uint256 bs) public view returns(uint256) {
        return SafeMath.div(SafeMath.mul(PSN, bs), SafeMath.add(PSNH, SafeMath.div(SafeMath.mul(PSN, rs), rt)));
    }
