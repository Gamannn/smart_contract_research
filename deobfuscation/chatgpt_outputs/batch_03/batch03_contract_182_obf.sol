...
contract DogezerPrivateSaleITO is Haltable {
    using SafeMath for uint256;
    ...
    function DogezerPrivateSaleITO(
        ...
        tokenReward = DGZToken(_tokenReward);
    }
    ...
    function () payable stopInEmergency onlyAfterStart onlyBeforeEnd public {
        ...
        if (amountSendTokens > tokensContractBalance) {
            uint refund = msg.value.sub(tokensContractBalance.mul(currentPrice));
        ...
        FundTransfer(msg.sender, msg.value, false);
