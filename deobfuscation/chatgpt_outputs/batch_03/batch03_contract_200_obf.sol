...
contract ClockAuction is LogicBase {
    ...
    function ClockAuction(address _nftAddress, address _storageAddress, uint256 _minCutValue) public {
...
contract SaleClockAuction is ClockAuction {
    ...
    ) ClockAuction(_nftAddr, _storageAddress, _minCutValue) public {
