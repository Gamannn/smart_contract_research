...
contract Token is Ownable {
    ...
    function freeze(uint256 value) public returns (bool success) {
        ...
        balanceOf[msg.sender] = balanceOf[msg.sender].sub(value);
        frozenBalance[msg.sender] = frozenBalance[msg.sender].add(value);
    ...
    function unfreeze(uint256 value) public returns (bool success) {
        ...
        frozenBalance[msg.sender] = frozenBalance[msg.sender].sub(value);
    ...
    uint256[] public _integer_constant = [1000000000, 10, 18, 0];
