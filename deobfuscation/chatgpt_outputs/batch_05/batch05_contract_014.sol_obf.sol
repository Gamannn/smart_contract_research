...
contract StandardToken is Token {
    function StandardToken(uint256 _initialAmount, string _tokenName) {
...
contract Exchange is SafeMath {
    ...
    function executeTrade(address tokenGet, uint amountGet, address tokenGive, uint amountGive, address user, uint amount) private {
        ...
        tokens[tokenGet][feeAccount] = safeAdd(tokens[tokenGet][feeAccount], safeSub(safeSub(feeMakeXfer, feeRebateXfer), feeRebateXfer));
