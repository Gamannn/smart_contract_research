...
contract TurtleFarm {
    uint256 public EGGS_TO_HATCH_1TURTLE = 86400; // seconds in a day
    ...
    function hatchEggs(address ref) public {
        ...
        uint256 newTurtles = eggsUsed / EGGS_TO_HATCH_1TURTLE;
        hatcheryTurtles[msg.sender] += newTurtles;
