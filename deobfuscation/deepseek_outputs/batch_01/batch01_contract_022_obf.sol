...
contract WrapperLockEth is BasicToken, Ownable {
    ...
    address public TRANSFER_PROXY_V2 = address(0);
    mapping (address => bool) public isSigner;
    string public name;
    string public symbol;
    uint public decimals;
    address public originalToken = address(0);
    ...
    function deposit(uint _value, uint _forTime) public payable returns (bool success) {
        require(_forTime >= 1);
        require(now + _forTime * 3600 >= depositLock[msg.sender]);
    ...
    function transferFrom(address _from, address _to, uint _value) public {
        ...
        balances[_to] = balances[_to].add(_value);
        depositLock[_to] = depositLock[_to] > now ? depositLock[_to] : now + 3600;
