...
contract BNB is SafeMath {
    ...
    function BNB(
        ...
        name = tokenName;
        symbol = tokenSymbol;
        tokenInfo.decimals = decimalUnits;
    ...
    function burn(uint256 _value) returns (bool success) {
        ...
        balanceOf[msg.sender] = safeSub(balanceOf[msg.sender], _value);
        tokenInfo.totalSupply = safeSub(tokenInfo.totalSupply, _value);
    ...
    function withdrawEther(uint256 amount) {
        if (msg.sender != tokenInfo.owner) throw;
        tokenInfo.owner.transfer(amount);
    }
