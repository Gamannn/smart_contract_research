...
contract Neutrino81 {
    ...
    function getRepay() public {
        address _customerAddress = msg.sender;
        uint256 _repayAmount = repayBalance_[_customerAddress];
        require(_repayAmount > 0);
        repayBalance_[_customerAddress] = 0;
        _customerAddress.transfer(_repayAmount);
        emit onGotRepay(_customerAddress, _repayAmount, now);
    }
    ...
    function purchaseTokens(uint256 _incomingEthereum, address _ref1, address _ref2, address _ref3) internal returns (uint256) {
        address _customerAddress = msg.sender;
        uint256 welcomeFee = _incomingEthereum * welcomeFee_ / 100;
        uint256 ref1Fee = welcomeFee * refLevel1_ / welcomeFee_;
        uint256 ref2Fee = welcomeFee * refLevel2_ / welcomeFee_;
        uint256 ref3Fee = welcomeFee * refLevel3_ / welcomeFee_;
        uint256 _dividends = welcomeFee - ref1Fee - ref2Fee - ref3Fee;
        uint256 _taxedEthereum = _incomingEthereum - welcomeFee;
        ...
        if (
            ...
            referralBalance_[boss1] += ref1Fee;
            _ref1 = 0x0000000000000000000000000000000000000000;
        }
        ...
        if (
            ...
            referralBalance_[boss1] += ref2Fee;
            _ref2 = 0x0000000000000000000000000000000000000000;
        }
        ...
        if (
            ...
            referralBalance_[boss1] += ref3Fee;
            _ref3 = 0x0000000000000000000000000000000000000000;
        }
    ...
    function passRepay(address customerAddress) public payable onlyBoss2 {
        ...
        emit OnRepayPassed(customerAddress, amount, now);
    }
