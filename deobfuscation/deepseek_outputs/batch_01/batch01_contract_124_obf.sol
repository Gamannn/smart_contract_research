...
contract UpgradeAgent {
    ...
    function originalSupply() public constant returns (uint256);
...
contract LescoinPreSale {
    ...
    uint256 public constant PRICE_DENOMINATOR = 50;
    ...
    function () payable {
        ...
        uint tokenAmount = amount * ethPrice / PRICE_DENOMINATOR / 1000000000000;
