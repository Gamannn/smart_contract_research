...
contract pays_commission {
    ...
    function transferCommissionGetter(address newCommissionGetter) onlyCommissionGetter public {
        commissionGetter = newCommissionGetter;
    }
    
    function changeMinimumCommission(
        uint256 newMinEtherCommission,
        uint256 newMinTokenCommission
...
contract SMBQToken is pays_commission, owned {
    ...
    function sell(uint256 amount) public {
        ...
        require(address(this).balance >= market_value);
