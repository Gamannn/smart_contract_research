...
contract DKZToken is MintableToken {
    string public name = "DEKZ COIN";
    string public symbol = "DKZ";
    uint256 public decimals = 18;
}

contract DKZCrowdsale is Crowdsale, Ownable {
    string[] public messages;

    function DKZCrowdsale(uint256 _startTime, uint256 _endTime, uint256 _rate, address _wallet)
    ...
    function mintTokens(address beneficiary) public returns (bool) {
