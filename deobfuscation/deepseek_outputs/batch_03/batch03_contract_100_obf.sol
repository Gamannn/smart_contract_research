...
contract LinkdropERC20 is ILinkdropERC20, LinkdropCommon {
    ...
    function checkClaimParams(
        ...
        if (_tokenAddress != address(0)) {
            ...
            require(
                IERC20(_tokenAddress).allowance(linkdropMaster, address(this)) >= _tokenAmount,
...
contract LinkdropERC721 is ILinkdropERC721, LinkdropCommon {
    ...
    function checkClaimParamsERC721(
        ...
        require(IERC721(_nftAddress).isApprovedForAll(linkdropMaster, address(this)), "INSUFF