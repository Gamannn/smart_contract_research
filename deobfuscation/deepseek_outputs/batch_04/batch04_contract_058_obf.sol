...
contract EBEHealthChain is ERC20, Ownable {
    using SafeMath for uint256;
    
    string public constant name = "EBE Health Chain";
    string public constant symbol = "EBEHC";
    uint8 public constant decimals = 6;
    uint256 public constant MAX_SUPPLY = 2800000000 * (10 ** uint256(decimals));
    
    uint256 public totalSupply;
    mapping(address => uint256) balances;
    mapping(address => mapping(address => uint256)) allowed;
    
    event GetETH(address indexed sender, uint256 amount);
