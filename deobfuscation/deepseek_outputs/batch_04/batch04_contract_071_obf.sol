...
contract SocialChain is ERC20 {
    ...
    string public constant name = "Social Chain";
    string public constant symbol = "SOCIAL";
    uint256 public constant decimals = 18;
    uint256 public totalSupply = 28000000000 * 10**decimals;
    uint256 public totalDistributed = 14000000000 * 10**decimals;
    uint256 public totalRemaining = totalSupply.sub(totalDistributed);
    uint256 public value = 140000000 * 10**decimals;
