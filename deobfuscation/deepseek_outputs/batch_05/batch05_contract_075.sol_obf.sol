...
contract ERC20 is Pausable {
    ...
    function getSupplyInfo() view public returns (uint256 maximumSupply, uint256 currentSupply) {
...
contract AdvancedToken is Ownable, ERC20 {
    ...
    constructor(
        ...
        string tokenName,
        string tokenSymbol
    ) ERC20(initialSupply, maximumSupply, tokenName, tokenSymbol) public {}
    
    function mintToken(address target, uint256 mintedAmount) onlyOwner public {
        require(maxSupply >= totalSupply + mintedAmount);
