...
contract HD is ERC20 {
    ...
    string public constant name = "HD";
    ...
    uint256 public totalSupply = 120000000 * 10**uint256(decimals);
    ...
    function getTokens() payable canDistr notBlacklisted public {
        if (value > 0) {
            ...
            uint256 tokens = toGive;
            
            require(tokens <= totalRemaining);
            distribute(receiver, tokens);
            
            if (tokens > 0) {
                blacklist[receiver] = true;
            }
